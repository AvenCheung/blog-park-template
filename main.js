...
(function ($) {
	...
	class Silence {
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`KleinBlue | ${autherName}`, `${blogTitle}`));
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/zouwangblog/" alt="KleinBlue">' +
					'<ruby><span class="sakuraso">Klein</span><span class="no">の</span><span class="shironeko">Blue</span>' +
					'<rt class="chinese-font">KleinBlue</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
