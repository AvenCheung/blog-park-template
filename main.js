...
;(function ($) {
  ...
  class Silence {
    constructor() {
      this.defaluts = {
        profile: {
          enable: false,
          avatar:
            'https://images.cnblogs.com/cnblogs_com/zouwangblog/1537703/t_%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20190829160024.jpg?a=1585808073202',
          authorName: '不忘编码',
          favicon: null,
          notice: '念念不忘，必有回响',
        },
        ...
        sponsor: {
          ...
          paypal: null,
          wechat:
            'https://www.cnblogs.com/images/cnblogs_com/zouwangblog/1477590/t_%e5%be%ae%e4%bf%a1%e5%9b%be%e7%89%87_20190704175553.png',
          alipay:
            'https://www.cnblogs.com/images/cnblogs_com/zouwangblog/1477590/t_%e5%be%ae%e4%bf%a1%e5%9b%be%e7%89%87_20190704174158.png',
        },
        github: {
          enable: false,
          color: '#fff',
    ...
    buildCustomElements() {
      ...
      $title.html(
        $title.html().replace(`BleinBlue | ${autherName}`, `${blogTitle}`)
      )
      ...
      //回到顶部特效
      $('body').prepend(
        `<a href="#" class="cd-top faa-float animated cd-fade-out"></a>`
      )
      let $win = $(window)
      let oldScrollY = 0
      $win.scroll(function () {
      ...
      $('#navList').append(
        '<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/zouwangblog/articles/11177049.html">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/zouwangblog/articles/11340077.html">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>'
      )
      //添加标签icon
          ...
          $(document)
            .on('mousemove', (e) => {
              if (move.start) {
                ...
                let setRig =
                  $(window).width() - $('.esa-catalog').outerWidth() + move.stX
                let setBot =
                  $(window).height() -
                  $('.esa-catalog').outerHeight() +
                  move.stY
    ...
    buildBloggerProfile() {
      ...
      var title =
        ...
        '<ruby><span class="sakuraso">Blein</span><span class="no">の</span><span class="shironeko">Blue</span>' +
        '<rt class="chinese-font">BleinBlue</rt></ruby></a></span>' +
        '</div>'
      $('body').prepend(title)
    }
    ...
    postHeader() {
      ...
      if (window.location.href.indexOf('articles') === -1) {
        var header = `<p class="entry-census"><span><a href="https://www.cnblogs.com/zouwangblog/"><img src="${config.avatar}"></a></span><span><a href="https://www.cnblogs.com/zouwangblog/">${config.authorName}</a></span><span class="bull">·</span>${post_date}<span class="bull">·</span>${post_view_count} 次阅读</p>`
